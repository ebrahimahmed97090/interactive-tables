...
let r2;
let c2;
qwsform.addEventListener('submit', e => {
    e.preventDefault();
    //loop run through matrices (first)
    for ( m1 = 0; matrices.length; m1++) {
        //loop run through matrix rows

        for ( r1 = 0; matrices[0].length; r1++) {
            //loop run through row cells
            for ( c1 = 0; matrices[0][0].length; c1++) {
    ...
    //loop run through matrices (second)
    for ( m2 = 0; matrices.length; m2++) {
        //loop run through matrix rows

        for (r2 = 0; matrices[0].length; r2++) {
            //loop run through row cells
            for (c2 = 0; matrices[0][0].length; c2++) {
